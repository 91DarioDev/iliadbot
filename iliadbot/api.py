...
def get_italia(tree):
    ...
    dic_italia["{} sms".format(emoji.sms)] = tree.xpath('/html/body/div[1]/div[1]/div/div/div/div/div[2]/div[2]/div[3]/div[1]/div[2]/div/div[1]/span[1]/text()')[0]
    dic_italia["{} internet".format(emoji.internet)] = tree.xpath('/html/body/div[1]/div[1]/div/div/div/div/div[2]/div[2]/div[3]/div[2]/div[1]/div/div[1]/span[1]/text()')[0]
    dic_italia["{} mms".format(emoji.mms)] =tree.xpath('/html/body/div[1]/div[1]/div/div/div/div/div[2]/div[2]/div[3]/div[2]/div[2]/div/div[1]/span[1]/text()')[0]
    return dic_italia

# estero xpaths
def get_estero(tree):
    dic_estero = collections.OrderedDict()
    dic_estero["{} chiamate".format(emoji.telephone)] = tree.xpath('/html/body/div[1]/div[1]/div/div/div/div/div[2]/div[2]/div[4]/div[1]/div[1]/div/div[1]/span[1]/text()')[0]
    dic_estero["{} sms".format(emoji.sms)] = tree.xpath('/html/body/div[1]/div[1]/div/div/div/div/div[2]/div[2]/div[4]/div[1]/div[2]/div/div[1]/span[1]/text()')[0]
    dic_estero["{} internet".format(emoji.internet)] = tree.xpath('/html/body/div[1]/div[1]/div/div/div/div/div[2]/div[2]/div[4]/div[2]/div[1]/div/div[1]/span[1]/text()')[0]
    dic_estero["{} mms".format(emoji.mms)] =tree.xpath('/html/body/div[1]/div[1]/div/div/div/div/div[2]/div[2]/div[4]/div[2]/div[2]/div/div[1]/span[1]/text()')[0]
    return dic_estero
