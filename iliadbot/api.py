...
# italia xpaths
def get_italia(tree):
    print(dic_italia["{} chiamate".format(emoji.telephone)] = tree.xpath('/html/body/div[1]/div[1]/div/div/div/div/div[2]/div[2]/div[3]/div[1]/div[1]/div/div[1]/span[1]/text()'),
    ...
    dic_italia["{} internet".format(emoji.internet)] = tree.xpath('/html/body/div[1]/div[1]/div/div/div/div/div[2]/div[2]/div[3]/div[2]/div[1]/div/div[1]/text()')[0]
